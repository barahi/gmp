...
public class RoundLogicServiceImpl implements RoundLogicService {
  ...
  public char startRound(RoomId roomId, int roundNumber) {
    gameStateStore.changeGamePhaseAndRound(roomId, GameLogicServiceImpl.RoundPhase.SUBMIT, roundNumber);
  ...
  public void storeAnswers(RoomId roomId, Map<PlayerId, String> playerAnswers, String category, int roundNumber) {
    gameStateStore.changeGamePhase(roomId, GameLogicServiceImpl.RoundPhase.SUBMIT);
...
//    gameStateStore.changeGamePhase(roomId, GameLogicServiceImpl.RoundPhase.VOTE);
//  }
//  @Override
...
//    gameStateStore.changeGamePhase(roomId, GameLogicServiceImpl.RoundPhase.SCORE);
